...
__ScriptName="update_dicomer.sh"
...
docker pull storage-shshukun:5050/dicomer:$NEW_VERSION
docker tag storage-shshukun:5050/dicomer:$NEW_VERSION shukun/dicomer
docker images
